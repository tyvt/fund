...
### 中证 A500 / A 股宽基（cn_broad）

- **指数**：中证A500（000510）、沪深300（000300）、中证500（000905）、中证1000（000852）、科创50（000688）
- **买入**：股债利差分位达标 + PE/PB 分位达标 + **近1年价格位置**
- **卖出**：PE 分位偏高且（利差收敛或距近期低点涨幅过大），须同时满足；阈值分指数配置
- **说明**：000510 与中证500（000905）为不同指数；A500 自 2024-09 发布
