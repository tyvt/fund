...
DATA_SOURCES = [
    {
        ...
        "indices": "930955、H30269、000510 等",
    ...
    },
    {
        ...
        "used_by": [
            ...
            "a500_data.build_a500_valuation_history",
    ...
    },
    {
        ...
        "frequency": "日频",
        "fields": "DGS10 收益率（%）",
        "used_by": ["ndx_data.fetch_us10y_history"],
    ...
    },
    {
        ...
        "used_by": ["ndx_data.fetch_ndx_pe_payload", "ndx_signal"],
    ...
    },
    {
        ...
        "frequency": "日频",
        "fields": "股息率（Yield）",
        "used_by": ["ndx_data.fetch_dividend_yield_proxy"],
    ...
    },
    {
        ...
        "used_by": ["美股宽基回测（纳斯达克 100，基日 1985-01-31）", "ndx_data.fetch_ndx_price_history"],
    ...
    },
    {
        ...
        "frequency": "日频",
        "fields": "美国国债收益率10年",
        "used_by": ["ndx_data.fetch_us10y_history（FRED 失败时回退）"],
